...
import com.kaltura.client.enums.KalturaBusinessProcessProvider;
...
public abstract class KalturaBusinessProcessServerBaseFilter extends KalturaFilter {
    ...
    public KalturaBusinessProcessServerStatus statusEqual;
    public KalturaBusinessProcessServerStatus statusNotEqual;
    public String statusIn;
    public String statusNotIn;
    public KalturaBusinessProcessProvider typeEqual;
    public String typeIn;

    public KalturaBusinessProcessServerBaseFilter() {
    }

    public KalturaBusinessProcessServerBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = KalturaBusinessProcessServerStatus.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("statusNotEqual")) {
                this.statusNotEqual = KalturaBusinessProcessServerStatus.get(ParseUtils.parseString(txt));
                continue;
                ...
                this.typeEqual = KalturaBusinessProcessProvider.get(ParseUtils.parseString(txt));
                continue;
