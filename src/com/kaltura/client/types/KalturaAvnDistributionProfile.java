...
public class KalturaAvnDistributionProfile extends KalturaConfigurableDistributionProfile {
    ...
    public KalturaAvnDistributionProfile(Element node) throws KalturaApiException {
        super(node);
