 ...
 */
public enum KalturaFeedDropFolderFileOrderBy implements KalturaEnumAsString {
    ...
    KalturaFeedDropFolderFileOrderBy(String hashCode) {
    ...
    public static KalturaFeedDropFolderFileOrderBy get(String hashCode) {
