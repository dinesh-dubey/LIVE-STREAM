...
public class KalturaFreewheelGenericDistributionJobProviderData extends KalturaConfigurableDistributionJobProviderData {
	/**  Demonstrate passing array of paths to the job  */
    public ArrayList<KalturaString> videoAssetFilePaths;
	/**  Demonstrate passing single path to the job  */
    public String thumbAssetFilePath;
    public ArrayList<KalturaCuePoint> cuePoints;

    public KalturaFreewheelGenericDistributionJobProviderData() {
    }

    public KalturaFreewheelGenericDistributionJobProviderData(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("videoAssetFilePaths")) {
                this.videoAssetFilePaths = ParseUtils.parseArray(KalturaString.class, aNode);
                continue;
