...
public class KalturaFtpDistributionFile extends KalturaObjectBase {
    ...
    public KalturaFtpDistributionFile() {
    }

    public KalturaFtpDistributionFile(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("assetId")) {
                ...
                this.contents = ParseUtils.parseString(txt);
                continue;
