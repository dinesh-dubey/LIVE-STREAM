 ...
 */
public enum KalturaWebexDropFolderFileOrderBy implements KalturaEnumAsString {
    ...
    KalturaWebexDropFolderFileOrderBy(String hashCode) {
    ...
    public static KalturaWebexDropFolderFileOrderBy get(String hashCode) {
