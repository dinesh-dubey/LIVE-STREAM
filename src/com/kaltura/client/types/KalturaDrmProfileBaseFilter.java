...
public abstract class KalturaDrmProfileBaseFilter extends KalturaFilter {
    ...
    public KalturaDrmProfileBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.statusEqual = KalturaDrmProfileStatus.get(ParseUtils.parseInt(txt));
                continue;
