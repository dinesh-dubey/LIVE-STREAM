...
public class KalturaDoubleClickDistributionProfile extends KalturaConfigurableDistributionProfile {
    ...
    public boolean ignoreSchedulingInFeed;

    public KalturaDoubleClickDistributionProfile() {
    }

    public KalturaDoubleClickDistributionProfile(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("channelTitle")) {
                ...
                continue;
            } else if (nodeName.equals("cuePointsProvider")) {
                this.cuePointsProvider = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("itemsPerPage")) {
                this.itemsPerPage = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("ignoreSchedulingInFeed")) {
                this.ignoreSchedulingInFeed = ParseUtils.parseBool(txt);
                continue;
            } 
        }
    }
