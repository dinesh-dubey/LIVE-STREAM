...
public class KalturaAttUverseDistributionFile extends KalturaObjectBase {
    public String remoteFilename;
    public String localFilePath;
    public KalturaAssetType assetType;
    public String assetId;

    public KalturaAttUverseDistributionFile() {
    }

    public KalturaAttUverseDistributionFile(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("remoteFilename")) {
                this.remoteFilename = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("localFilePath")) {
