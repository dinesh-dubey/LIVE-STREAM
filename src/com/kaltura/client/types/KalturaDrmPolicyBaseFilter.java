...
public abstract class KalturaDrmPolicyBaseFilter extends KalturaFilter {
    ...
    public KalturaDrmPolicyBaseFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("partnerIdEqual")) {
                ...
                this.statusEqual = KalturaDrmPolicyStatus.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("statusIn")) {
                this.statusIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("scenarioEqual")) {
                this.scenarioEqual = KalturaDrmLicenseScenario.get(ParseUtils.parseString(txt));
                continue;
