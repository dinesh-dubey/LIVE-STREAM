...
public class KalturaSynacorHboDistributionProfile extends KalturaConfigurableDistributionProfile {
    ...
    public KalturaSynacorHboDistributionProfile(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("feedUrl")) {
                ...
                continue;
            } else if (nodeName.equals("feedSubtitle")) {
                this.feedSubtitle = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("feedLink")) {
                this.feedLink = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("feedAuthorName")) {
                this.feedAuthorName = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
