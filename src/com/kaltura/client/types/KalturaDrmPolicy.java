...
import com.kaltura.client.enums.KalturaDrmPolicyStatus;
import com.kaltura.client.enums.KalturaDrmLicenseScenario;
import com.kaltura.client.enums.KalturaDrmLicenseType;
import com.kaltura.client.enums.KalturaDrmLicenseExpirationPolicy;
...
public class KalturaDrmPolicy extends KalturaObjectBase {
    ...
    public KalturaDrmPolicy(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.status = KalturaDrmPolicyStatus.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("scenario")) {
                this.scenario = KalturaDrmLicenseScenario.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("licenseType")) {
                this.licenseType = KalturaDrmLicenseType.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("licenseExpirationPolicy")) {
                this.licenseExpirationPolicy = KalturaDrmLicenseExpirationPolicy.get(ParseUtils.parseInt(txt));
                continue;
