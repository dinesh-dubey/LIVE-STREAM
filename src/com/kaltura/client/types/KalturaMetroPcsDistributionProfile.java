...
public class KalturaMetroPcsDistributionProfile extends KalturaConfigurableDistributionProfile {
    ...
    public KalturaMetroPcsDistributionProfile() {
    }

    public KalturaMetroPcsDistributionProfile(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("ftpHost")) {
                ...
                this.copyright = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("entitlements")) {
                this.entitlements = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("rating")) {
                this.rating = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("itemType")) {
                this.itemType = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
