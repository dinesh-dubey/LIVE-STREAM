...
public class KalturaEventNotificationTemplateService extends KalturaServiceBase {
    ...
    public KalturaPushNotificationData register(String notificationTemplateSystemName, ArrayList<KalturaEventNotificationParameter> userParamsArray) throws KalturaApiException {
        KalturaParams kparams = new KalturaParams();
        kparams.add("notificationTemplateSystemName", notificationTemplateSystemName);
        kparams.add("userParamsArray", userParamsArray);
