...
import com.kaltura.client.enums.KalturaDailymotionGeoBlockingMapping;
...
public class KalturaDailymotionDistributionProfile extends KalturaConfigurableDistributionProfile {
    public String user;
    public String password;
    public KalturaDailymotionGeoBlockingMapping geoBlockingMapping;
    ...
    public KalturaDailymotionDistributionProfile(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("user")) {
                ...
                continue;
            } else if (nodeName.equals("geoBlockingMapping")) {
                this.geoBlockingMapping = KalturaDailymotionGeoBlockingMapping.get(ParseUtils.parseInt(txt));
                continue;
            } 
        }
    }
