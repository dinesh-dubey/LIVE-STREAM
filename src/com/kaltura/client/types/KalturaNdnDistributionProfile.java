...
public class KalturaNdnDistributionProfile extends KalturaConfigurableDistributionProfile {
    ...
    public KalturaNdnDistributionProfile() {
    }

    public KalturaNdnDistributionProfile(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("feedUrl")) {
                ...
                continue;
            } else if (nodeName.equals("itemMediaRating")) {
                this.itemMediaRating = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
