...
import com.kaltura.client.enums.KalturaActivitiBusinessProcessServerProtocol;
...
public class KalturaActivitiBusinessProcessServer extends KalturaBusinessProcessServer {
    public String host;
    public int port = Integer.MIN_VALUE;
    public KalturaActivitiBusinessProcessServerProtocol protocol;
    public String username;
    public String password;

    public KalturaActivitiBusinessProcessServer() {
    }

    public KalturaActivitiBusinessProcessServer(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("host")) {
                ...
                this.protocol = KalturaActivitiBusinessProcessServerProtocol.get(ParseUtils.parseString(txt));
                continue;
