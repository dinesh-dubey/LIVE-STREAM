...
import com.kaltura.client.enums.KalturaPlayReadyLicenseRemovalPolicy;
import com.kaltura.client.enums.KalturaPlayReadyMinimumLicenseSecurityLevel;
...
public class KalturaPlayReadyPolicy extends KalturaDrmPolicy {
    ...
    public ArrayList<KalturaPlayReadyRight> rights;

    public KalturaPlayReadyPolicy() {
    }

    public KalturaPlayReadyPolicy(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("gracePeriod")) {
                ...
                this.licenseRemovalPolicy = KalturaPlayReadyLicenseRemovalPolicy.get(ParseUtils.parseInt(txt));
                continue;
                ...
                this.minSecurityLevel = KalturaPlayReadyMinimumLicenseSecurityLevel.get(ParseUtils.parseInt(txt));
                continue;
            } else if (nodeName.equals("rights")) {
                this.rights = ParseUtils.parseArray(KalturaPlayReadyRight.class, aNode);
                continue;
            } 
        }
    }
