...
public class KalturaBpmEventNotificationIntegrationJobTriggerData extends KalturaIntegrationJobTriggerData {
    ...
    public KalturaBpmEventNotificationIntegrationJobTriggerData() {
    }

    public KalturaBpmEventNotificationIntegrationJobTriggerData(Element node) throws KalturaApiException {
        super(node);
