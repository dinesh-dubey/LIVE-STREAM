...
public class KalturaUverseDistributionProfile extends KalturaConfigurableDistributionProfile {
    ...
    public KalturaUverseDistributionProfile() {
    }

    public KalturaUverseDistributionProfile(Element node) throws KalturaApiException {
        super(node);
