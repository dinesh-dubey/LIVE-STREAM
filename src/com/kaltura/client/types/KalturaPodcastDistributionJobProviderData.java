...
public class KalturaPodcastDistributionJobProviderData extends KalturaDistributionJobProviderData {
    public String xml;
    public int metadataProfileId = Integer.MIN_VALUE;
    public int distributionProfileId = Integer.MIN_VALUE;

    public KalturaPodcastDistributionJobProviderData() {
    }

    public KalturaPodcastDistributionJobProviderData(Element node) throws KalturaApiException {
        super(node);
